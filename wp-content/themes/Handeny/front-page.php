    ...
    <section class="heading">
        <div class="heading__container">
            <div class="heading__text-block">
                ...
                <h1 class="heading__title">JEWELLERY STORE</h1>
                <div class="heading__description">
                    An sincerity so extremity he additions. Her yet
                    there truth merit. Mrs all projecting favourable
                    now unpleasing. Son law garden chatty temper. Oh
                    children provided to mr elegance marriage
                    strongly
                </div>
                <div class="heading__buttons">
                    <a href="#" class="heading__button button button_white">
                        shop now
                    </a>
                    <a href="#" class="heading__button button">
                        VIEW MORE
                    </a>
                </div>
            </div>
            <div class="heading__image-block">
                <div class="heading__image-ibg">
                    <picture><source data-srcset="<?php echo get_template_directory_uri();?>/assets/img/main-block/main-image.webp" srcset="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=" type="image/webp"><img src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII="  data-src="<?php echo get_template_directory_uri();?>/assets/img/main-block/main-image.jpg" alt="Sample Image" /></picture>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="featured__featured-product featured-product">
                    <div class="featured-product__text-block">
                        ...
                        <div class="featured-product__description">
                            Started now shortly had for assured
                            hearing expense led juvenile.
                        </div>
                        <a href="#" class="featured-product__button button"><span>shop now</span></a>
                    </div>
                    <div class="featured-product__image-ibg">
                        <picture><source data-srcset="<?php echo get_template_directory_uri();?>/assets/img/other/featured-main.webp" srcset="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=" type="image/webp"><img src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII="  data-src="<?php echo get_template_directory_uri();?>/assets/img/other/featured-main.jpg" alt="" /></picture>
                    </div>
                </div>
                            ...
                            <div class="featured__slide featured-slide swiper-slide">
                                <div class="featured-slide__text-block">
                                    <h4 class="featured-slide__title">
                                        <a href="#">Curabitur sitamet</a>
                                    </h4>
                                    <a href="#" class="featured-slide__categoty">Jewelry</a>
                                    <div class="featured-slide__price">
                                        $169.00
                                    </div>
                                </div>
                                <div class="featured-slide__image-block">
                                    <a href="#" class="featured-slide__image-ibg"><picture><source data-srcset="<?php echo get_template_directory_uri();?>/assets/img/other/featured.webp" srcset="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=" type="image/webp"><img src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII="  data-src="<?php echo get_template_directory_uri();?>/assets/img/other/featured.png" alt="" /></picture></a>
                                    <div class="featured-slide__tools">
                                        <button class="featured-slide__tool icon-button">
        ...
        <div class="special__container">
            <div class="special__offer">
                <div class="special__text-block">
                    ...
                    <h2 class="special__title">Mauris Rhoncus</h2>
                    <div class="special__description">
                        Curabitur non nullat amet.
                    </div>
                    <a href="" class="special__button button button_grey">View MORE</a>
                </div>
                <div class="special__image-ibg">
                    <picture><source data-srcset="<?php echo get_template_directory_uri();?>/assets/img/other/special.webp" srcset="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=" type="image/webp"><img src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII="  data-src="<?php echo get_template_directory_uri();?>/assets/img/other/special.jpg" alt="" /></picture>
                </div>
            </div>
            <div class="special__products">
                <ul class="special__column">
                    ...
                    <li class="special__item item-special">
                        ...
                        <a href="#" class="item-special__image"><picture><source srcset="<?php echo get_template_directory_uri();?>/assets/img/other/featured-small.webp" type="image/webp"><img src="<?php echo get_template_directory_uri();?>/assets/img/other/featured-small.png" alt="" /></picture></a>
                    </li>
                    <li class="special__item item-special">
                        <div class="item-special__text-block">
                            <h4 class="item-special__title">
                    ...
                    <div class="blog__wrapper swiper-wrapper">
                        <div class="blog__slide swiper-slide">
                            <div class="blog__text-block">
                                <h3 class="blog__title"><a href="#">A flat-picked chair made of a seat and sticks</a></h3>
                                <div class="blog__author"><span>Posted by</span><picture><source srcset="<?php echo get_template_directory_uri();?>/assets/img/other/avatar.webp" type="image/webp"><img src="<?php echo get_template_directory_uri();?>/assets/img/other/avatar.jpg" alt=""></picture><span>S. Rogers</span></div>
                            ...
                            <div class="blog__image-block">
                                <h5 class="blog__category">Wooden accessories</h5>
                                <div class="blog__date">
                                    <span>23</span><span class="month">JUL</span>
                                </div>
                                <div class="blog__image-ibg"><picture><source data-srcset="<?php echo get_template_directory_uri();?>/assets/img/other/blog.webp" srcset="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=" type="image/webp"><img src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII="  data-src="<?php echo get_template_directory_uri();?>/assets/img/other/blog.jpg" alt=""></picture></div>
                            </div>
                        </div>
                        <div class="blog__slide swiper-slide">
                            <div class="blog__text-block">
                        ...
                        <div class="blog__slide swiper-slide">
                            <div class="blog__text-block">
                                <h3 class="blog__title"><a href="#">A flat-picked chair made of a seat and sticks</a></h3>
                                <div class="blog__author"><span>Posted by</span><picture><source srcset="<?php echo get_template_directory_uri();?>/assets/img/other/avatar.webp" type="image/webp"><img src="<?php echo get_template_directory_uri();?>/assets/img/other/avatar.jpg" alt=""></picture><span>S. Rogers</span></div>
                                <div class="blog__description">Parturient in potenti id rutrum duis torquent parturient sceler isque sit vestibulum a posuere scelerisque viverra urna. Egestas tristique vestib...</p>
                                </div>
                                <a href="#" class="blog__button">Continue reading</a>
                            </div>
                            <div class="blog__image-block">
