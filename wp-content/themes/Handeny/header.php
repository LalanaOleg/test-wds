    ...
    <header class="header">
        <div class="header__container">
            <div class="header__menu menu">
                <a href="#" class="menu__logo"><img src="<?php echo get_template_directory_uri();?>/assets/img/icons/logo.svg" alt=""></a>
                <nav class="menu__body">
                    <ul class="menu__list">
                        <li class="menu__item">
                            <div data-open-sub-menu class="menu__title"><span>Home</span></div>
                            <ul data-sub-menu class="menu__sub-menu">
                                <li class="menu__sub-item"><a href="#">Some link</a></li>
                                <li class="menu__sub-item"><a href="#">Some link</a></li>
                                <li class="menu__sub-item"><a href="#">Some link</a></li>
                                <li class="menu__sub-item"><a href="#">Some link</a></li>
                            </ul>
                        ...
                        <li class="menu__item">
                            <div data-open-sub-menu class="menu__title"><span>Shop</span></div>
                            <ul data-sub-menu class="menu__sub-menu">
                                <li class="menu__sub-item"><a href="#">Some link</a></li>
                                <li class="menu__sub-item"><a href="#">Some link</a></li>
                                <li class="menu__sub-item"><a href="#">Some link</a></li>
                        ...
                        <li class="menu__item">
                            <div data-open-sub-menu class="menu__title"><span>blog</span></div>
                            <ul data-sub-menu class="menu__sub-menu">
                                <li class="menu__sub-item"><a href="#">Some link</a></li>
                                <li class="menu__sub-item"><a href="#">Some link</a></li>
                                <li class="menu__sub-item"><a href="#">Some link</a></li>
                        ...
                        <li class="menu__item">
                            <div data-open-sub-menu class="menu__title"><span>pages</span></div>
                            <ul data-sub-menu class="menu__sub-menu">
                                <li class="menu__sub-item"><a href="#">Some link</a></li>
                                <li class="menu__sub-item"><a href="#">Some link</a></li>
                                <li class="menu__sub-item"><a href="#">Some link</a></li>
                        ...
                        <li class="menu__item">
                            <div data-open-sub-menu class="menu__title"><span>elements</span></div>
                            <ul data-sub-menu class="menu__sub-menu">
                                <li class="menu__sub-item"><a href="#">Some link</a></li>
                                <li class="menu__sub-item"><a href="#">Some link</a></li>
                                <li class="menu__sub-item"><a href="#">Some link</a></li>
                        ...
                        <li class="menu__item">
                            <div data-open-sub-menu class="menu__title"><span>buy</span></div>
                            <ul data-sub-menu class="menu__sub-menu">
                                <li class="menu__sub-item"><a href="#">Some link</a></li>
                                <li class="menu__sub-item"><a href="#">Some link</a></li>
                                <li class="menu__sub-item"><a href="#">Some link</a></li>
                ...
                <div class="menu__icons">
                    <button type="button" class="menu__icon icon-button">
                    ...
                    <button type="button" class="menu__cart">
                        <div class="menu__icon menu__icon_cart">
                            <svg viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="menu__cart-amount">0</div>
                        </div>
                        <span class="menu__cart-total">$0.00</span>
