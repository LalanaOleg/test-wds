(() => {
    ...
    (() => {
            ...
            if (subMenuTriggers) {
                ...
                subMenuTriggers.forEach((trigger => {
                    trigger.addEventListener("click", (event => {
                        ...
                        if (activeMenu && activeMenu !== trigger) activeMenu.parentElement.classList.remove("active");
                        activeMenu = trigger;
        ...
        function initSliders() {
            if (document.querySelector(".featured__swiper")) new Swiper(".featured__swiper", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: "auto",
            ...
            if (document.querySelector(".blog-swiper")) new Swiper(".blog-swiper", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 3,
